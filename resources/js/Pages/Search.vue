...
async function loadMore() {
    if (!get_data.value || is_empty.value) {
        return;
    }
    get_data.value = false;

    const res = await fetch(
        `/api/search?id=${last_id.value}&q=${usePage().props.value.query}`
    );
        ...
        <template #main>
            <div class="py-2">
                <div class="max-w-7xl mx-auto">
                    <div class="overflow-hidden">
                        ...
                        >
                            Search results for "{{$page.props.query}}"
                        </h2>
                        <div class="">
                            <div
                                id="scroll"
                                class="mx-auto max-w-2xl py-8 pt-0 px-6 lg:max-w-7xl lg:px-8"
                            >
                                <div
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <div>
                                                <h3
                                                    class="text-xl sm:text-md text-gray-700"
                                                >
                                                    <a
                                                        :href="
                                                            route(
            ...
            <div class="px-4 py-12" :class="get_data && is_empty ? 'hidden' : ''">
                <div class="flex justify-center items-center">
                    <div
                        class="spinner-border animate-spin inline-block w-10 h-10 border-gray-700 rounded-full"
                        role="status"
                    >
