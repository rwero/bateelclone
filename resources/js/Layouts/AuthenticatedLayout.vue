                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Navigation Links -->
                            <div
                                class="hidden space-x-6 md:-my-px md:ml-10 md:flex"
                            >
                                <NavLink
                        ...
                        <div class="hidden md:flex md:items-center md:ml-6">
                            ...
                            <div class="relative text-gray-700">
                                ...
                                <TextInput
                                    type="text"
                                    class=" block w-full focus:border-0 hover:border-gray-400 text-sm"
                                    autofocus
...
<MagnifyingGlassIcon class="h-5 w-5 absolute top-2 bottom-0 right-2 " />
                            ...
                            <div class="text-gray-500 bg-white hover:text-gray-700 cursor-pointer" @click="showCart = true">
            ...
            <main class="max-w-7xl mx-auto sm:py-4 sm:px-4 font-serif">
                ...
                <div class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] justify-center  max-w-7xl mx-auto py-6 px-6  lg:px-8 gap-6">
                    <div class="">
				<h1 class=" text-xl ">Bateel International</h1>
                    ...
                    <button><FB class="h-5 w-5" /></button>
                    <button><Inst class="h-5 w-5" /></button>
                    <button><Linkedin class="h-5 w-5" /></button>
                    <button><Twitter class="h-5 w-5" /></button>
                    <button><Youtube class="h-5 w-5" /></button>
                </div>
            </footer>
        </div>
    </div>
